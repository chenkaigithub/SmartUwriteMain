...
namespace 比美特医护在线.比美特写作助手
{
    public class FtpHelper
    {
        ...
        public static void Test()
        {
            ...
            fw.Download(@"E:\FTP_DOWNLOAD", "BIMT200.dll");
        ...
        private string Upload(string filename)
        {
            ...
            {
                Log4Net.LogHelper.WriteLog(typeof(FtpHelper), ex);
        ...
        public void Download(string filePath, string fileName)
        {
            ...
            {
                Log4Net.LogHelper.WriteLog(typeof(FtpHelper), "filePath" + filePath + "\nfileName" + fileName + "\n" + ex);
        ...
        public string[] GetFilesDetailList()
        {
            ...
            List<string> _listDownloadFiles = new List<string>();
            try
            {
                ...
                //line = reader.Read();//.ReadLine();
                while (line != null)
                {
                    string _strTemp = line.Substring(line.LastIndexOf(" "));
                    _listDownloadFiles.Add(_strTemp);
                    //result.Append(line);
                    //result.Append("\n");
                    line = reader.ReadLine();
                }
                ...
                reader.Close();
                response.Close();
                return _listDownloadFiles.ToArray();
