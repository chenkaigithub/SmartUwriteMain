...
{
    public partial class frmIndexFeldList : Form
    {
        ...
        public frmIndexFeldList()
        {
            InitializeComponent();
        }

        public frmIndexFeldList(frmTempletManager frmTempletManager)
        {
        ...
        public frmIndexFeldList(BIMTClassLibrary.frmTempletManager frmTempletManager, int p)
        {
            // TODO: Complete member initialization
            this.frmTempletManager = frmTempletManager;
            this.p = p;
